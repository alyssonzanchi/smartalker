...
export default async function MainSidebarSuperAdmin() {
    ...
    <Sidebar>
      ...
      <SidebarMain>
        ...
        <SidebarNav className="border-none">
          <SidebarNavHeader>
            <SidebarNavHeaderTitle>Admin</SidebarNavHeaderTitle>
          </SidebarNavHeader>
          <SidebarNavMain>
            <SidebarNavLink
              href="/app/admin/dashboard"
              active={isActive('/app/admin/dashboard')}
            >
              <LuLayoutDashboard className="w-4 h-4 mr-3" />
              Dashboard
            </SidebarNavLink>
            <SidebarNavLink
              href="/app/admin/add-business"
              active={isActive('/app/admin/add-business')}
            >
              <MdOutlineAddBusiness className="w-4 h-4 mr-3" />
              Adicionar Empresa
            </SidebarNavLink>
            <SidebarNavLink
              href="/app/admin/add-user"
              active={isActive('/app/admin/add-user')}
            >
